      ...
      <main className="pt-24 pb-16 flex items-center justify-center min-h-[85vh]">
        <Card className="w-full max-w-md mx-6 bg-card border-border">
          <CardHeader className="text-center">
            ...
            <p className="text-muted-foreground mt-2">Join SOMADZ and start advertising</p>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSignup} className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input placeholder="John Doe" value={fullName} onChange={(e) => setFullName(e.target.value)} className="pl-10 bg-secondary border-border" required />
                </div>
              </div>
              <div className="space-y-2">
                <Label>Email</Label>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input type="tel" placeholder="+1 234 567 8900" value={phone} onChange={(e) => setPhone(e.target.value)} className="pl-10 bg-secondary border-border" />
                </div>
              </div>
              <div className="space-y-2">
